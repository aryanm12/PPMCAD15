...
After this Lab, Run the steps mentioned in 03-AdvanceDockerwithGenAI\Multi-stage-nodejs-example\README.md

This will show you the real world use case of running a nodejs application in production with single stage docker image vs multi-stage docker image

---

## Lab 2: Security & Resource Management
